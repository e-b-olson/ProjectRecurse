...
export default function AddSkillsModal({ projectId, taskId, userId, onClose, onCreated }: Props) {
    ...
    >
      <div className="w-full max-w-md rounded-2xl bg-slate-900 border border-slate-700 p-8 shadow-2xl">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-white font-semibold text-lg">Add Skills</h2>
          <button
            onClick={onClose}
            aria-label="Close"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="skill-name" className="text-slate-400 text-xs font-medium uppercase tracking-wider">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="skill-description" className="text-slate-400 text-xs font-medium uppercase tracking-wider">
              Description
            </label>
            <textarea
